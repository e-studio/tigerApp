function buscarControl (Control) {
  ...
  success: function (data) {
    ...
    document.getElementById("apaterno").value = Respuesta[2];
    document.getElementById("amaterno").value = Respuesta[3];
    document.getElementById("grupo").value = Respuesta[4];
    document.getElementById("especialidad").value = Respuesta[5];
