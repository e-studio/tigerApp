...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
        <?php
          $respuesta = Datos::busca($idBuscar, "paquetes");
        ?>
                  ...
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-4">
                        ...
                        <input type="text" class="form-control" name="costo" value ="<?php echo $respuesta['costo'];?>">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="row">
                      <div class="col-6">
                        ...
                        <input type="text" class="form-control" name="clases" value ="<?php echo $respuesta['clases'];?>">
                      </div>
                      <div class="col-6">
                         <label for="exampleInputPassword1">Vigencia</label>
                        <input type="text" class="form-control" name="vigencia" value ="<?php echo $respuesta['caducaDias'];?>">
                      </div>
                    </div>
                  </div>
